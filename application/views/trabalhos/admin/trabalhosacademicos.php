  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?=base_url('painel/trabalhosacademicos')?>">Trabalhos Acadêmicos <span class="sr-only">(Página atual)</span></a>
      </li>
      <li class="nav-item">
...
<table class="table">
  ...
  <tbody>  
    ...
    foreach($trabalhos as $trabalho)
    {
        ...
        echo '<td>'?> <a  href="<?=base_url('listar/candidatotrabalhosacademicos/'. $trabalho->inscricao_id)?>" class="btn btn-primary">Ficha</a><? '</td>';
        echo '</tr>'; 
