<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item ">
        <a class="nav-link" href="<?=base_url('juradoph')?>">Home </a>
      </li>     
      <li class="nav-item active">
        <a class="nav-link " href="<?=base_url('juradoph/praticashumanisticas')?>">Práticas Humanísticas <span class="sr-only">(Página atual)</span></a>
      </li>     
    </ul>
...
<table class="table">
  ...
  <tbody>  
    ...
    foreach($trabalhos as $trabalho)
    {
        ...
        echo '<td>'?> <a  href="<?=base_url('juradoph/candidatopraticashumanisticas/'. $trabalho->inscricao_id)?>" class="btn btn-primary">Ficha</a><? '</td>';
        echo '</tr>'; 
