...
<div class="desc">
             <p><b>Categoria:</b> <span style="color: red;">Reportagens Jornalísticas</span></p>

             <p>Categoria reservada exclusivamente a reportagens de jornalistas sobre Direitos Humanos. Podem ser inscritas matérias de qualquer mídia. Todas precisam ser enviadas em arquivos de PDF. Portanto, reportagens em vídeo, áudio ou imagem, devem ser colocadas em arquivos de texto, com a divulgação dos links das matérias.

            Os concorrentes deverão utilizar o nome próprio nos trabalhos, não podendo haver qualquer texto de dedicatória ou agradecimento. </p>
</div>
            <div class="row">
                <div class="col-lg-8">
<div class="container formCadastro">
        <?php echo form_open_multipart('reportagens/cadastrar'); ?>     
