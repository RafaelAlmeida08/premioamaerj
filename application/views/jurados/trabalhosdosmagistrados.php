<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?=base_url('juradotm/trabalhosdosmagistrados')?>">Trabalhos dos Magistrados</a>
      </li>
    </ul>
...
<div class="container jumbopainel">
  <div class="jumbotron">
    ...
    <p class="lead">Este é o seu painel da categoria <span style="color:red"><strong>Trabalhos dos Magistrados.</strong></span>Você terá acesso a todos os trabalhos registrados, no menu acima.</p>
    <hr class="my-4">
    <p>Está com algum problema? Envie um e-mail para <span style="color:red;">contato@rafaelalmeidadev.com</span></p>
    <a class="btn btn-primary btn-lg" href="<?=base_url('juradotm/trabalhosdosmagistrados')?>" role="button">Inscrições</a>
  </div>
</div>