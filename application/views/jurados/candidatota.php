<div class="container">
  <h1>Candidato: <?php echo $inscricao_nome;?></h1>
    <form>
      ...
      <?php echo '<td>'?> <a target="_blank" href="<?=base_url('uploads/inscricoes/academicos/'. $inscricao_pdf)?>" class="btn btn-primary">Trabalho</a><? '</td>'; ?>

      <a href="<?=base_url('juradota/trabalhosacademicos')?>" class="btn btn-primary">Voltar</a>
