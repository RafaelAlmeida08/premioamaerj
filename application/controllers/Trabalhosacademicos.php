...
class Trabalhosacademicos extends CI_Controller {
...

    {
        ...
        $config['upload_path'] =FCPATH . "uploads/inscricoes/academicos";
    ...
    // Se não existir o cpf no banco de dados, ele faz o cadastro, passando o array para a nossa model
       ...
       if(!$this->trabalhos_model->vCPFta($data['inscricao_cpf']))

       {
            ...
            $this->trabalhos_model->insert_trabalhosacademicos($data);
            $this->session->set_flashdata('sucesso', 'Trabalho cadastrado com sucesso!');
            redirect('trabalhos/trabalhosacademicos');
       }
